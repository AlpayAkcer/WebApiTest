...
$(document).ready(function () {
    var yearltArticleUrl = app.Urls.yearlyArticleUrl
    ...
    var totalDeletedArticleUrl = app.Urls.totalDeletedArticleUrl;
    ...
    $.ajax({
        ...
        type: "GET",
        url: totalDeletedArticleUrl,
        dataType: "json",
        success: function (data) {
            $("h3#totalDeletedArticle").append(data);
        },
        error: function () {
            toastr.error("Silinen Makaleler Analizleri Yüklenirken Hata Oluştu.", "Hata");
        }
    });
